...
@lua fun_check_count.lua result_fc.txt result_fc.txt
...
rem for /r E:\cbprojects\luadec\angrybirds_lua %%f in (*.lua) do @float_angrybirds\luadec -fc %%f 2>>error_fc_ab.txt | findstr /r /c:"-- function check" >>result_fc_ab.txt

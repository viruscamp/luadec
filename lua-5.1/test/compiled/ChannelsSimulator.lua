...
-- Command line was: todo\channelssimulator.luac 
...
BF_ChannelsSimulator.GetActualCostTrain = function(l_2_0, l_2_1)
  if BF_ChannelsSimulator.emulate then
    ...
    l_2_1 = l_2_1 * (1 - (BigFoot_f3c54c9070e9d9b5d2edc1a3da85f7e1) * 0.01 - (BigFoot_91152949e45b6a5d8be1d756bfea1c3f) * 0.01)
    return l_2_1
  else
    return GetActualCostTrain(l_2_0, l_2_1)
  end
end
...
BF_ChannelsSimulator.Clear = function(l_5_0)
  ...
  ChannelsPanel.UpdateGuidePage(l_5_0)
  ChannelsPanel.UpdateCommonPage(l_5_0)
  ChannelsPanel.UpdateTrainValue(l_5_0)
end

BF_ChannelsSimulator.Reset = function(l_6_0)
  BF_ChannelsSimulator.Init()
  ChannelsPanel.UpdateGuidePage(l_6_0)
  ChannelsPanel.UpdateCommonPage(l_6_0)
  ChannelsPanel.UpdateTrainValue(l_6_0)
end
...
BF_ChannelsSimulator.CanOpenVenation = function(l_8_0, l_8_1)
  if not VenationRequireLevel[l_8_1] or l_8_0 < VenationRequireLevel[l_8_1] then
  ...
  local BigFoot_669fa01852f90cf7b764d63244920269 = BF_ChannelsSimulator.BigFoot_5f64b171232f3a1579d5f9f0bb50931f
  local l = BigFoot_669fa01852f90cf7b764d63244920269[l_8_1]
  local skill = GetSkill(l_8_1, 1)
  l = l and l + 1 or 1
  if skill.dwMaxLevel < l then
    return false, 0
  end
  if not BF_ChannelsSimulator.preview and BF_ChannelsSimulator.BigFoot_2cce3085b1cc1a5a7245e15eb15402e8 < BF_ChannelsSimulator.GetActualCostTrain(GetClientPlayer(), VenationCost[l_8_1][l]) then
    return false, ERR_OPEN_VENATION_NOT_ENOUGH_TRAIN
  end
  if BigFoot_82c1f7ff9fe375991bbc112c6d247f17[l_8_1] then
    for _,v in ipairs(BigFoot_82c1f7ff9fe375991bbc112c6d247f17[l_8_1]) do
  ...
  if VenationRequirement[l_8_1] and #VenationRequirement[l_8_1] ~= 0 then
    local v = VenationRequirement[l_8_1]
...
BF_ChannelsSimulator.UpdateGuidePage = function(l_9_0)
  local BigFoot_669fa01852f90cf7b764d63244920269 = BF_ChannelsSimulator.BigFoot_5f64b171232f3a1579d5f9f0bb50931f
  local wndGuide = l_9_0:Lookup("Wnd_Guide")
  local BigFoot_9c987de176f2b454baede402cee36bfa = GetClientPlayer()
...
BF_ChannelsSimulator.UpdateCommonPage = function(l_10_0)
  local BigFoot_669fa01852f90cf7b764d63244920269 = BF_ChannelsSimulator.BigFoot_5f64b171232f3a1579d5f9f0bb50931f
...
BF_ChannelsSimulator.UpdateTrainValue = function(l_11_0)
  local handle = l_11_0:Lookup("Wnd_Guide", "")
  local BigFoot_9c987de176f2b454baede402cee36bfa = GetClientPlayer()
  if BF_ChannelsSimulator.emulate then
...
BFConfigPanel.RegisterCheckButton("ChannelSimulator", "EnableChannelSimulator", "启用经脉模拟器", true, function(l_16_0, l_16_1)
  BF_ChannelsSimulator.enabled = l_16_0
  if l_16_0 then

...
BFConfigPanel.RegisterCheckButton("InfoBox", "ShowCoordinatev2", "显示坐标", true, function(enabled)
  if enabled then
...
BFConfigPanel.RegisterCheckButton("InfoBox", "ShowMoneyv2", "显示金钱", false, function(enabled)
  if enabled then
...
BFConfigPanel.RegisterCheckButton("InfoBox", "ShowLatencyv2", "显示网络延迟", false, function(enabled)
  if enabled then
...
BFConfigPanel.RegisterCheckButton("InfoBox", "ShowTimev2", "显示时间", true, function(enabled)
  if enabled then
...
BFConfigPanel.RegisterCheckButton("InfoBox", "ShowFPSv2", "显示FPS", false, function(enabled)
  if enabled then
...
BFConfigPanel.RegisterCheckButton("InfoBox", "ShowDistancev2", "显示目标距离", true, function(enabled)
  if enabled then
